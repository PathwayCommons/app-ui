...
describe('Test Enrichment Analysis Service', function () {
  ...
  it('parameters: valid genes, valid minSetSize, valid maxSetSize, empty backgroundGenes', function () {
  ...
  it('parameters: valid genes, valid minSetSize, invalid maxSetSize, empty backgroundGenes', function () {
  ...
  it('parameters: valid genes, valid minSetSize, valid maxSetSize, valid backgroundGenes', function () {
