...
describe('Test Enrichment Analysis Service', function () {
  ...
  it('parameters: valid genes, valid minSetSize, valid maxSetSize, empty background', function () {
    return (enrichment(['AFF4'], {minSetSize: 3, maxSetSize:400, background: []})).then(
      //resolved
      res=> {
      const result = {
        "pathwayInfo": {
  ...
  it('parameters: valid genes, valid minSetSize, invalid maxSetSize, empty background', function () {
    return (enrichment(['AFF4'], {minSetSize: 3, maxSetSize:"not a number", background: []})).then(
      //resolved
      res => {
  ...
  it('parameters: valid genes, valid minSetSize, valid maxSetSize, valid background', function () {
